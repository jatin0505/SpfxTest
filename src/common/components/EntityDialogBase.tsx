...
export {
    IDataDialogBase,
    IDataDialogBaseProps,
    IDataDialogBaseState,
    DataDialogMode,
    UpdateDataCallback
};

export abstract class EntityDialogBase<T extends Entity<any>, P extends IDataDialogBaseProps<T>, S extends IDataDialogBaseState<T>> extends DataDialogBase<T, P, S> {
    constructor(props: P) {
        super(props);
